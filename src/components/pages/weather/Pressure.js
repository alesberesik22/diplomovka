...
class Humidity extends React.Component {
  ...
  return (
    <div className="Temperature">
      Average pressure forecast
      <div className='weatherContainer pt -3 pb-3'>
        <WeatherBody day={date[0]} icon={icon[0]} minTemp={pressure[0]} description={description[0]}/>
        <WeatherBody day={date[1]} icon={icon[1]} minTemp={pressure[1]} description={description[1]}/>
        <WeatherBody day={date[2]} icon={icon[2]} minTemp={pressure[2]} description={description[2]}/>
        <WeatherBody day={date[3]} icon={icon[3]} minTemp={pressure[3]} description={description[3]}/>
        <WeatherBody day={date[4]} icon={icon[4]} minTemp={pressure[4]} description={description[4]}/>
      </div>
    </div>
  );
}
